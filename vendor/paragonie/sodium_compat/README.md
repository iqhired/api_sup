...
```php
<?php
use function Sodium\crypto_sign_detached;use function Sodium\crypto_sign_keypair;use function Sodium\crypto_sign_publickey;use function Sodium\crypto_sign_secretkey;use function Sodium\crypto_sign_verify_detached;require_once "/path/to/sodium_compat/autoload.php";

$alice_kp = crypto_sign_keypair();
$alice_sk = crypto_sign_secretkey($alice_kp);
$alice_pk = crypto_sign_publickey($alice_kp);

$message = 'This is a test message.';
$signature = crypto_sign_detached($message, $alice_sk);
if (crypto_sign_verify_detached($signature, $message, $alice_pk)) {
    echo 'OK', PHP_EOL;
} else {
